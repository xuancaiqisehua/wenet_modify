...
def Dataset(data_type,
    ...
    """
    assert data_type in ['raw', 'shard','format']
    ...
    if data_type == 'shard':
        ...
        dataset = Processor(dataset, processor.parse_format)
    else:
    ...
    #bandpass = conf.get('bandpass_filter',False)
    #if bandpass:
    #  dataset = Processor(dataset, processor.bandpass_aug)
    ...
    if noise_aug:
       ...
       if resample_conf['resample_rate']!=8000:
