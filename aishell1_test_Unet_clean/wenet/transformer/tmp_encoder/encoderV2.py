...
class ConformerEncoderUnet(torch.nn.Module):
    ...
    def forward(
        ...
        output_size_list = [320,256,128,64,2048,1792,1536,1280,1024,768] 
        layers=[]
        embdding=[]
        for output_size in output_size_list:
            ...
            chunk_masks = add_optional_chunk_mask(xs, masks,
                                                  ...
                                                  self.static_chunk_size,
                                                  num_decoding_left_chunks)
        encoders = torch.nn.ModuleList(layers)
