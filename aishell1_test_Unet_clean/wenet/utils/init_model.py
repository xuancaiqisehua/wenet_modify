...
#from wenet.transformer.encoderV1 import ConformerEncoder, TransformerEncoder
from wenet.transformer.encoder import TransformerEncoder,ConformerEncoderUnet
...
def init_model(configs):
    ...
    if encoder_type == 'conformer':
        ...
        encoder = ConformerEncoderUnet(input_dim,
                                   global_cmvn=global_cmvn,
                                   **configs['encoder_conf'])
    else:
    ...
    #   decoder = TransformerDecoder(vocab_size, encoder_output_size,
    #   ctc = CTC(vocab_size, encoder.output_size())
    #                                 **configs['decoder_conf'])
    #elif encoder_type=='Unet' and decoder_type=='bitransformer':
    #    assert 0.0 < configs['model_conf']['reverse_weight'] < 1.0
    #    assert configs['decoder_conf']['r_num_blocks'] > 0
    #    decoder = BiTransformerDecoder(vocab_size,encoder_output_size,
    #    ctc = CTC(vocab_size, encoder_output_size)
    #                                   **configs['decoder_conf'])
